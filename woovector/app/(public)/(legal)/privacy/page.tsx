      ...
      <div className="lg:flex-1">
        ...
        >
          <section id="introduction">
            ...
            <p>
              ShipKit.ai is operated by ShipKit SRL, headquartered in Cluj, Romania. For any privacy-related inquiries, please reach us via the
              <Link href="/contact" className="font-medium text-primary hover:underline">
                contact form
              </Link>
              so we can track your request and respond with a reference number.
            </p>
            <p>
