      ...
      <div className="lg:flex-1">
        ...
        >
          ...
          <section id="contact">
            ...
            <p>
              If you have questions about these Terms or need support, contact us through the
              <Link href="/contact" className="font-medium text-primary hover:underline">
                WooVector support form
              </Link>
              so we can give you a reference number and respond quickly.
            </p>
