...
> **Template Context**: The user has already chosen a template (chat-simple, chat-saas, rag-saas, or mastra-agent-saas) with an existing schema. Your job is strategic enhancement, not building from scratch. 
