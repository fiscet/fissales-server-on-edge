...
**Template Context**: The user has already chosen their template type (chat-simple, chat-saas, rag-saas, or mastra-agent-saas), so you know their general direction and monetization approach.
...
[Auto-include if using chat-saas, rag-saas, or mastra-agent-saas]
...
**Template Type:** [chat-simple/chat-saas/rag-saas/mastra-agent-saas - based on context]
...
[Only include if using paid template - chat-saas, rag-saas, mastra-agent-saas]
...
- **Detect business model** - Add billing integration for paid templates (chat-saas, rag-saas, mastra-agent-saas)
